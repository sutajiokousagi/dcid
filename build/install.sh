...
# Copy all binaries
cp --verbose --preserve ${PROJBASE}/write-disabled/${TARGETDIR}/bin/dcid ${COPYDEST}/rfs1/usr/bin/
...
cp --verbose --preserve ${PROJBASE}/write-disabled/${TARGETDIR}/bin/dcid ${COPYDEST}/rfs2/usr/bin/
